...
- [repo-summarizer/](./repo-summarizer/) - Generate a structured summary of any repository: purpose, tech stack, architecture, key components, and getting-started commands.
